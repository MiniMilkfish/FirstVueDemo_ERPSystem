...
<template>
  <div class="page_control_container">
    <div class="page_condition">
      <a-space>
        ...
        <a-input v-model:value="formState.c" placeholder="工地项目名称" />
        <a-select
          ref="select"
        ...
        >
          ...
          <a-select-option value="tom">未完成</a-select-option>
        </a-select>
      </a-space>
    </div>
  ...
  >
    ...
    >
      <a-form-item name="f" label="人员名称">
        <a-select
          v-model:value="formState.f"
          mode="multiple"
          style="width: 100%"
          placeholder="请选择派单人员"
          :options="
      ...
      <a-form-item name="b" label="时间">
        <a-range-picker v-model:value="formState.b" style="width: 100%" />
      </a-form-item>
      <a-form-item name="c" label="车辆信息">
        <a-select
          ref="select"
          ...
          @change="handleChange"
        >
          <a-select-option value="1">沪ABCDEFG</a-select-option>
          <a-select-option value="2">沪ABCDEFG</a-select-option>
          <a-select-option value="3">沪ABCDEFG</a-select-option>
          <a-select-option value="4">沪ABCDEFG</a-select-option>
          <a-select-option value="5">沪ABCDEFG</a-select-option>
        </a-select>
      </a-form-item>
      <a-form-item name="e" label="工地列表">
        <a-collapse v-model:activeKey="activeKey">
          <a-collapse-panel key="1" header="工地名称1">
            <commonCompBuildingSiteDetail title="工地名称1" />
          </a-collapse-panel>
          <a-collapse-panel key="2" header="工地名称2">
            <commonCompBuildingSiteDetail title="工地名称2" />
          </a-collapse-panel>
        </a-collapse>
      </a-form-item>
    </a-form>
...
<script>
  ...
  import CONSTANT_DISPATCH_LIST from "../utils/constantDispatchList";
  import commonCompBuildingSiteDetail from "./commonCompBuildingSiteDetail.vue";
  ...
  export default defineComponent({
    components: { commonCompBuildingSiteDetail },
    data() {
      return {
        contractId: "",
        data,
        columns: CONSTANT_DISPATCH_LIST.TABLE_COLUMNS,
      };
    },
    setup() {
      const formRef = ref();
